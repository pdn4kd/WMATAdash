run_app:
	...
	find pages_files -exec sed -i.bak 's|_dash-component-suites|WMATAdash\\/_dash-component-suites|g' {} \;
	find pages_files -exec sed -i.bak 's|_dash-layout|WMATAdash/_dash-layout.json|g' {} \;
	find pages_files -exec sed -i.bak 's|_dash-dependencies|WMATAdash/_dash-dependencies.json|g' {} \;
	find pages_files -exec sed -i.bak 's|_reload-hash|WMATAdash/_reload-hash|g' {} \;
	find pages_files -exec sed -i.bak 's|_dash-update-component|WMATAdash/_dash-update-component|g' {} \;
	find pages_files -exec sed -i.bak 's|assets|WMATAdash/assets|g' {} \;
